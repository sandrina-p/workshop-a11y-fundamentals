...
- Be more than a _div'eloper_. Some HTML tags add extra meaning and functionality.
- The heading structure must follow the page content, not necessarily the visual designs.
...
- As a designer, include the "invisible copy" in the mockups.
</details>
