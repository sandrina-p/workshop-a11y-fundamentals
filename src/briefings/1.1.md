...
In thee <a href="../exercises/1.1.html" target="_blank">exercise page</a>, there are multiple accessibility problems related to color and proportions:
...
**Hint 4:** In Chrome, you can emulate a motion settings. In Dev Tools, go to Settings > Rendering. Scroll down until "Rendering" and select the preferred motion setting.
